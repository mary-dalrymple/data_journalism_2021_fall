...
**Answer** Differences in capitalization
...
**Answer** All caps to title case is the primary change (but not in all cases); change from hyphenated to non-hyphenated
...
**Answer** all caps to title case, lowercase to title case, and in at least one case a change to all caps when the count exceeded title case
...
**Answer** The n_gram_merge clustered cities within minor spelling variations to match the correct spelling. 
