...
**Answer** I get a dataframe with 5 columns and a row for each state and DC. It shows which presidential candidate won in 2016, the percent of the vote that went to Trump, the percent of businesses (small businesses?) that got a PPE loan, and the PPE loan amount per employee.
...
**Answer** I get a scatter plot of percent vote for Trump versus the cuont of businesses receiving PPE loans, showing a moderately positive correlation. 
...
### Task 4: Plot data
**Task** Run the following code. Describe the plot. What do you see?
**Answer** I see a scatterplot of percent Trump vote vs PPE amount per employee, which shows a weak positive relationship. 
...
**Answer** This analysis shows an R value of .52 for the relationship between Trump vote and number of businesses receiving PPE; .22 for the relationship between Trump vote and PPE amount per employee.
...
**Answer** I see the t-test output for the relationship between the percent Trump vote and the businesses receiving PPE loans. The p-value is 00008607, showing very unlikely to be due to chance. 
...
**Task** Run the following code. Describe the model output. What do you see?
**Answer** This t-test output shows the relationship between percent Trump vote and the size of loan to be probably unrelated, with a p-value of 0.22. 
...
**Answer** The dataframe shows states that went to Clinton got PPE loans for an average of 28% of businesses with an average $5,704 per employee, whereas states that went to Trump got loans for an average of 37% of businesses with an average $6,021 per employee. 
...
**Answer** The p-value of this t-test (0.23) suggest there isn't a significant relationship between the amount of PPP loans per employee and whether the state went to Clinton or Trump.
...
### Task 10: Run t-test
**Task** Run the following code. Describe the output. What do you see?
**Answer** This t-test supports the analysis by vote percentage above and shows a p-value of .002, suggesting a significant relationship between the number of businesses that got PPP loans and whether the state voted for Trump. As an aside, though, I'd want to run this analysis using state population. The top states in the Trump and Clinton lists differ a lot by population size, and I'd be interested in knowing whether that's a stronger relationship. 
