...
**Answer** Start with the Maryland PPP data, and then group the loans by county name. Add up the number of loans for each county, sort them with the most loans at the top, then identify and print the top 10.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** A bar chart with 10 bars and mostly unreadable county name label s, which appear to be in alphabetical order. 
...
**Answer** The bar chart is now ordered left to right from lowest to highest count of loans. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The bar chart now shows counties on the y-axis ordered from most loans to least, and the county names can now be read because they run horizontally. Count is read from the x-axis. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The background inverted, so now we see the bars against white with grey gridlines (instead of grey with white gridlines).
...
**Answer** The background has changed to a light blue, and the gridlines have been replaced with horizontal lines running through each bar. We seem to have also gotten a better and bigger font for the lables, and the chart now speaks with a posh British accent. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** We now have the title, "Maryland Counties with the Most PPP Loans" atop the barchart. The axis labels have changed, and the source attribution is in the bottom right. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The code produced a 2-column table of the loan approval dates and count of loans approved on that date. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** There are major spikes of high-volume approval at the start of the program, followed by much smaller rates of approval until a lull after July into January. Starting sometime after January 2021, approvals pick back up in what appears to be a somewhat regular cycle until sometime before July 2021. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Now, you can see that the biggest spike happened at the end of April 2020, the trickling out of loans continued through August 2020. Loan approvals picked up again mid-January 2021 and continued on a regular cycle until June 2021. But I had to walk through the tick marks to figure this out, as the labels are pretty much unreadable. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The x-axis labels all rotated to make them readable.
