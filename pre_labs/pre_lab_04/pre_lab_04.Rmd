...
**Answer** Yes, all three have the same column names, same data types.
...
#the "joining" message a little too irresolute; did I get the df?
```
...
**Answer** Can't join on the zip columns because the data types are incompatible -- one is character, the other is  numeric. 
...
**Answer** No, no demographic data other than the data original to the PPP dataset.
...
**Answer** 44,032 PPP loans went to ZCTAs with more than 50% non-Hispanic Black populations. The median loan was $20,000 and the average loan was $53,836.46.
...
**Answer** 113,937 loans, median $20,833 and average $88,140.24
...
**Answer** Only 148 loans went to rural, majority Black and non-Hispanic ZCTAs. The average loan was $44,328.87 and the median $19,621. However, 43,884 loans went to urban, majority Black non-Hispanic ZCTAs, where the average loan was $53,868.53 and the median loan was $20,000.
...
**Answer** 18,337 loans went to businesses and individuals in rural majority White areas, an average loan of $73,694.14. 95,600 loans went to businesses in urban majority White areas, with the average loan at $90,911.14. Both areas had the same median loan amount, $20,833.
