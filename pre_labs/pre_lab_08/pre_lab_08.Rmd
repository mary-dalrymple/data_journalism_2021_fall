...
**Answer** Nevada had the largest percentage growth from 2000 to 2010.
...
**Answer** Howard County has the highest estimated median household income. 
...
**Answer** Somerset and Caroline Counties saw estimated median incomes fall. However, Somerset's 2019 margin of error is so wide as to make any valid comparison with 2019 data difficult. Caroline County's loss (0.27%) is so small that the margin of error encompasses both a loss and a gain in median income. 
