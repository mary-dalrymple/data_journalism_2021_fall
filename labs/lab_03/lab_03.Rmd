...
The database also reports that the original loan amount was $2,880,600. To understand the discrepancy between the amount forgiven and the amount approved, it might be necessary to trace back the company's loan applications to see if there were multiple applications and whether the $5,126,619 better reflects the law firm's multiple applications, instead of the reported "current approved amount" of $5,068,472. 
